  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="px-6 py-10 space-y-14 max-w-lg mx-auto">
        ...
        {/* ===== LINE予約案内 ===== */}
        <div className="rounded-xl bg-[#06C755] px-4 py-3.5 flex items-center gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="shrink-0 bg-white text-[#06C755] text-xs font-bold px-3 py-1.5 rounded-full hover:bg-green-50 transition-colors whitespace-nowrap"
          >
            LINEで相談
          </a>
        </div>
